...
- The option Logger can be used to let the request library log to a gildas/go-logger. By default, it logs to a NilStream (see https://pkg.go.dev/github.com/gildas/go-logger).
